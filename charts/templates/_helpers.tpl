...
{{/*
────────────────────────────────────────────────────────────────────────────────
CIS profile: host-level prerequisites (Packer baked image reference)

DECISION: CIS host prerequisites are baked into the OS image via Packer,
NOT injected at runtime. The zsys-studio driver is used as-is — no patching.
This helper is kept as a REFERENCE for what the Packer image must contain.
...
────────────────────────────────────────────────────────────────────────────────
*/}}
{{- define "hetzner-cluster-template.cisPackerReference" -}}
#!/bin/bash
